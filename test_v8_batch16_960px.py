"""
YOLO11s v8 Batch16 960px - 기본 추론
"""
...
MODEL_PATH = 'yolo11s_v8_batch16_960px/best.pt'

print("="*70)
print("YOLO11s v8 Batch16 960px - 기본 추론")
print("="*70)
...
output_dir = Path('yolo11s_v8_batch16_960px/test_results')
