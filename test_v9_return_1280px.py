"""
YOLO11s v9 Return of 1280px - 기본 추론
"""
...
MODEL_PATH = 'yolo11s_v9_return_of_1280px/best.pt'

print("="*70)
print("YOLO11s v9 Return of 1280px - 기본 추론")
print("="*70)
...
output_dir = Path('yolo11s_v9_return_of_1280px/test_results')
