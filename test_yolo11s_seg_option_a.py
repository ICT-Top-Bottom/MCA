"""
YOLO11s-seg Option A 모델 테스트
testImage 폴더의 이미지들로 테스트하고 결과 저장
"""
...
# 모델 로드
print("="*70)
print("YOLO11s-seg Option A 모델 테스트")
print("="*70)
model = YOLO('yolo11s_seg_option_a/best.pt')
print("✅ 모델 로드 완료\n")

# 테스트 이미지 경로
test_images = Path('testImage')
output_dir = Path('yolo11s_seg_option_a/test_results')
