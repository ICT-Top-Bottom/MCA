"""
YOLO11s v7 High-res Classification Focus - 기본 추론
"""
...
MODEL_PATH = 'yolo11s_v7_highres_cls_focus/best.pt'

print("="*70)
print("YOLO11s v7 High-res Classification Focus - 기본 추론")
print("="*70)
...
output_dir = Path('yolo11s_v7_highres_cls_focus/test_results')
