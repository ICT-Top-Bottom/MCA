"""
YOLO11n-seg CCTV Augmented 모델 추론 테스트
testImage 폴더의 이미지로 테스트하고 결과를 yolo11n_seg_cctv_augmented/results에 저장
"""
...
# 기존 results 폴더 처리
results_dir = Path('yolo11n_seg_cctv_augmented/results')
...
# 모델 로드
model_path = 'yolo11n_seg_cctv_augmented/best.pt'
model = YOLO(model_path)

print("="*60)
print("YOLO11n-seg CCTV Augmented Inference Test")
print("="*60)
print(f"Model: {model_path}")
print(f"Test Images: testImage/")
print("Expected: High Precision/Recall (92%+/93%+)")
print("")
...
results = model.predict(
    ...
    save_txt=False,
    save_conf=True,
    project='yolo11n_seg_cctv_augmented',
    name='results',
    exist_ok=True,
...
print(f"\n✅ Inference completed!")
print(f"Results saved to: yolo11n_seg_cctv_augmented/results/")
...
# 비교
print("\nComparison:")
print("  yolo11n_seg_option1:        12 detections")
print("  yolo11n_seg_cctv_augmented: {} detections".format(sum(total_detections.values())))
print("="*60)
