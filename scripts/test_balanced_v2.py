"""
YOLO11n Balanced v2 모델로 testImage 폴더 이미지 추론
"""
...
# 모델 로드
model_path = Path(__file__).parent / 'yolo11n_balanced_v2' / 'best.pt'
model = YOLO(str(model_path))

# 테스트 이미지 디렉토리
test_dir = Path(__file__).parent / 'testImage'
output_dir = Path(__file__).parent / 'test_balanced_v2_results'

print("=" * 70)
print("YOLO11n Balanced v2 모델 테스트")
print("=" * 70)
print(f"\nModel: {model_path}")
