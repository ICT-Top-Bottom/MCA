"""
YOLO11s v10 Exact v4 Replica - 기본 추론
"""
...
MODEL_PATH = 'yolo11s_v10_exact_v4_replica/best.pt'

print("="*70)
print("YOLO11s v10 Exact v4 Replica - 기본 추론")
print("="*70)
...
output_dir = Path('yolo11s_v10_exact_v4_replica/test_results')
